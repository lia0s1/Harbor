...
extension TerminalView {
    ...
    /// Scrolls to the current screen bottom (the prompt / active cursor position).
    /// Call this after programmatically sending a command so the viewport follows output.
