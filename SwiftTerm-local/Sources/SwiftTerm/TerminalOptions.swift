...
public struct TerminalOptions {
    ...
    /// Whether OSC 52 may request clipboard writes; disabled by default because terminal output is untrusted.
    public var allowOsc52ClipboardAccess: Bool
    /// Maximum total bytes to keep for kitty image data; defaults to 128MB and is clamped to 512MB.
    ...
    public static let `default` = TerminalOptions.init(cols: 80,
                                                       ...
                                                       allowOsc52ClipboardAccess: false,
                                                       kittyImageCacheLimitBytes: 128 * 1024 * 1024,
  ...
  public init(cols: Int = Self.default.cols, rows: Int = Self.default.rows, convertEol: Bool = Self.default.convertEol, termName: String = Self.default.termName, cursorStyle: CursorStyle = Self.default.cursorStyle, screenReaderMode: Bool = Self.default.screenReaderMode, scrollback: Int = Self.default.scrollback, tabStopWidth: Int = Self.default.tabStopWidth,
              enableSixelReported: Bool = Self.default.enableSixelReported, allowOsc52ClipboardAccess: Bool = Self.default.allowOsc52ClipboardAccess, kittyImageCacheLimitBytes: Int = Self.default.kittyImageCacheLimitBytes, ansi256PaletteStrategy: Ansi256PaletteStrategy = Self.default.ansi256PaletteStrategy) {
        self.cols = cols
        self.rows = rows
        ...
        self.allowOsc52ClipboardAccess = allowOsc52ClipboardAccess
