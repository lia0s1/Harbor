...
``TerminalOptions/kittyImageCacheLimitBytes``, which defaults to 128 MB and is
clamped to 512 MB. A decoded image is limited to 64 MB, and chunked Base64
transmissions are rejected before their pending buffer can exceed 8 MB.
