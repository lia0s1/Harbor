...
The command-line tool is excluded from the default package graph to keep library
and test builds free of development-only remote dependencies. Enable it in the
current shell before running the examples:
