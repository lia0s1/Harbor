...
TEAM_ID="${TEAM_ID:?Set TEAM_ID to your Apple Developer Team ID (e.g. export TEAM_ID=XXXXXXXXXX)}"
DEVELOPER_IDENTITY="${DEVELOPER_IDENTITY:?Set DEVELOPER_IDENTITY to your Developer ID certificate name (e.g. export DEVELOPER_IDENTITY=\"Developer ID Application: Your Name (XXXXXXXXXX)\")}"
